...
format_orf(infile="/scratch/bioschool/phd/blz227562/nm_nr/coding_transcripts/orfs/15052024_pep_TTG_coding_bifunc_genes.fa",
           outfile="/scratch/bioschool/phd/blz227562/nm_nr/coding_transcripts/orfs/15072024_formatted_allGenes_codingPEP_TTGorfs.faa")