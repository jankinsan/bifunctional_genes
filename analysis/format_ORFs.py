...
def format_orf(infile, outfile):
    ...
    dat_gene=pd.read_csv("E:\\bifunctional_genes\\dat\\15122023\\counts\\18122023_GRCh38.p14_gene_accessions.csv")
...
print("Running for ATG..")
format_orf(infile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_pep_ATG_bifunc_genes.fa",
           outfile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_formatted_pep_ATG_bifunc_genes.csv")
print("Running for CTG..")
format_orf(infile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_pep_CTG_bifunc_genes.fa",
           outfile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_formatted_pep_CTG_bifunc_genes.csv")
print("Running for TTG..")
format_orf(infile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_pep_TTG_bifunc_genes.fa",
           outfile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_formatted_pep_TTG_bifunc_genes.csv")
print("Running for GTG..")
format_orf(infile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_pep_GTG_bifunc_genes.fa",
           outfile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_formatted_pep_GTG_bifunc_genes.csv")


print ("Running for ORFs in mRNAs..")
print("Running for ATG..")
format_orf(infile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_pep_ATG_bifunc_genes.fa",
           outfile="E:\\bifunctional_genes\\dat\\15122023\\ORFs\\predicted\\03052024_formatted_pep_ATG_bifunc_genes.csv")
print("Running for CTG..")
